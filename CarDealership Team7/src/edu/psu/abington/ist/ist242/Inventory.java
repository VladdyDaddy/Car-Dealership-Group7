...
class Vehicle {
     ...
     * @return Prints Cars by location
     * @author Team 7
     * @version 1.0
     * @since 2020-06-24
     */
     ...
     *     This method is used inside the methods to add cars
     *     so that after user enters the specific number, car setters
     *     store this information to the Car object being created.
     * </p>
     * @return Number of doors
     * @author Team 7
     * @version 1.0
    ...
    /**
     * setDrivetrain sets vehicle wheel run number
     * <p>
     *     It asks for user input and then returns the number
     *     of wheels running on the vehicle, which are preset by the Wheeldrive enumeration.
     *     This method is used inside the methods to add cars
     *     so that after user enters the specific number, car setters
     *     store this information to the Car object being created.
     * </p>
     * @return Number of Wheels running
     * @author Team 7
     * @version 1.0
     * @since 2020-06-24
     */
